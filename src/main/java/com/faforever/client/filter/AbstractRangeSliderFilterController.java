...
public abstract class AbstractRangeSliderFilterController<U, T> extends AbstractFilterNodeController<U, T> {
  ...
  protected boolean hasLowDefaultValue() {
    return rangeSlider.getLowValue() == minValue;
  }

  protected boolean hasHighDefaultValue() {
